...
from account import Account, ETH_API
...
class THORTrader:
    ...
    def estimate_swap_output(self, in_amount, in_asset: Asset, out_asset: Asset):
        ...
        tx_fee = self.oracle.get_transaction_fee(in_asset)
        output_after_fee = output_before_fee - network_fee
        THOR_TRADER_log.info(
            f'input: {in_amount} {in_asset}\n'
            f'expected transaction fee: {tx_fee} {in_asset.symbol}\n'
        ...
        return output_after_fee, tx_fee

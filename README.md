...
# Adaptation
This repo was forked from HoodieOnWho to use the APIs created for interacting with Thorchain.
The ThorRestart.py contains the logic used to arbitrage the Thorchain pools once they restarted after the second hack.
